...
static unsigned int LVDCR   	@0x0E:rpage 0;//LVD control register
...
static unsigned int LVDIMR   	@0x0E:rpage 1;//LVD interrupt and Wake-up register
static unsigned int SCR   		@0x0F:rpage 1;//Systerm Control register
...
/* RE bits(LVD Control register) */
static bit _LVD		@0x0E@0:rpage 0;
static bit LVDIF	@0x0E@0:rpage 0;  
...
/* TBHP bits(Table point register for instruction TBRD) */
static bit MLB		@0x05@7:rpage 1;	//choose the MSB or LSB machine code to move into the reigster
static bit Rbit9	@0x05@1:rpage 1;	//
static bit Rbit8	@0x05@0:rpage 1;	//

/* TBLP bits(Table point register for instruction TBRD) */
...
/* LVDIMR bit(LVD interrupt and Wake up register */
...
/*SCR bit(Systerm control register)*/
static bit TIMERSC	@0X0F@6:rpage 1;	//TCC clock source select
static bit CPUS		@0X0F@5:rpage 1;	//CPU Oscilator source select
static bit IDLE		@0X0F@4:rpage 1;	//Idle mode enable bit
static bit RCM1		@0X0F@1:rpage 1;	//
static bit RCM0		@0X0F@0:rpage 1;	//	RCM1	RCM0	Frequency(MHz)
									/*	//	  1		1			4
										//	  1		0			16
										//	  0		1			8
										//	  0		0			1*/	